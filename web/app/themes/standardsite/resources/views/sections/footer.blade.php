<footer class="fdr-footer" role="contentinfo">
  <div class="fdr-footer-inner">
    <div class="fdr-footer-logo">
      <img src="/app/uploads/ett-makleri-logo.svg" alt="ETT MÄKLERI" class="fdr-footer-logo-svg">
    </div>
    <div class="fdr-footer-cols">
      <div class="fdr-footer-col">
        <a href="{{ home_url('/om-oss') }}">VÅRA FASTIGHETSMÄKLARE</a>
